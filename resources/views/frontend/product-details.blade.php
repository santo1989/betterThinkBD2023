                    ...
                    <div class="row justify-content-between">
                        <div class="row">
                            <div class="col-md-4 col-sm-12 pt-2 pb-2 px-1 py-1">
                                ...
                                <div class="card h-100 pt-2 pb-2 px-1 py-1"
                                    style=" background-color:rgba(0,119,191,255);">
                                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 pt-2 pb-2 px-1 py-1">
                                ...
                                <div class="card h-100 pt-2 pb-2 px-1 py-1"
                                    style=" background-color:rgba(0,119,191,255);">
                                    <div class="card-body">
                                        <h5 class="card-title text-center">Discount {{ $product->discount_amount }} %</h5>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card h-100 pt-2 pb-2 px-1 py-1">
                                    <div class="card-body">
                                        <h5 class="card-title text-center">For Buy {{ $product->point_needed }} Point Need</h5>
