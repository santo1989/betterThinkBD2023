<div id="layoutSidenav_nav">
    <nav class="sb-sidenav accordion sb-sidenav-dark text-white" id="sidenavAccordion" style="background-image: linear-gradient(#1358a7,
...
@endphp
        ...
        <div class="sb-sidenav-footer text-white text-center" style="background-image: linear-gradient(#1358a7, #0680c6, #273871); text-color:white;" >
